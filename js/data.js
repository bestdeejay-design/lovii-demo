...
/* ============================================================
   LOVII CLUB · LOVII PAY — сид данных клубного профиля
   ------------------------------------------------------------
   Терминология (канон владельца, 2026-09):
   • Платформа — «Лови» (LOVII)
   • Клуб      — Лови Клуб / LOVII CLUB (LC)
   • Карта     — LOVII PAY: карта участника клуба, включает
                 счёт и баланс (карты жителя нет)
   • 1 балл = 1 ₽, баллы не сгорают, вывод через СБП (canon VISION.md)
   ============================================================ */
const LOVII_CLUB_SEED = {

  // ---- Карта LOVII PAY ----
  // Номер по стандарту Visa/Мир: 16 цифр, группировка 4-4-4-4, Luhn.
  // ПРЕФИКС (BIN) — демо-заглушка; задача генерации номеров готовится
  // отдельно — при подключении генератора заменить PAY_BIN.
  pay: {
    bin: '5536 9138',            // ← демо-BIN (стиль Т-Банк МИР), заменить генератором
    tail: '4210 7753',           // ← демо-хвост, Luhn-валиден
    holder: 'ALEXANDRA LOVII',   // латиницей — как на платёжных картах
    valid: '09/29',
    cvv: '824',
  },

  // ---- Счёт кэшбека (составляющая LOVII PAY) ----
  account: {
    balance: 1250,       // ₽ — совпадает с баллами профиля (1 балл = 1 ₽)
    monthEarned: 323,    // начислено за месяц, ₽
    cashback: 2,         // текущая ставка, % — от статуса LC Gold
    withdrawnTotal: 3400,// выведено через СБП за всё время, ₽
  },

  // ---- Уровни клуба LC: покупки в месяцах, ₽ (демо-пороги) ----
  tiers: [
    { id: 'start',  name: 'LC Start',  need: 0,     cb: 1,   perks: ['Кэшбек баллами 1%', 'Оплата QR у партнёров'] },
    { id: 'silver', name: 'LC Silver', need: 5000,  cb: 1.5, perks: ['Кэшбек 1,5%', 'Приоритет записи у партнёров'] },
    { id: 'gold',   name: 'LC Gold',   need: 15000, cb: 2,   perks: ['Кэшбек 2%', '×2 кэшбек по пятницам', 'Подарок ко дню рождения'] },
    { id: 'ink',    name: 'LC Ink',    need: 30000, cb: 3,   perks: ['Кэшбек 3%', 'Ранний доступ к акциям', 'Консьерж района'] },
  ],
  currentTier: 'gold',
  monthSpend: 12400,   // покупки за месяц для прогресса до следующего уровня, ₽

  // ---- Витрина привилегий клуба ----
  privileges: [
    { icon: 'percent',   title: '×2 кэшбек по пятницам', sub: 'У всех партнёров района', tone: 'gold' },
    { icon: 'gift',      title: 'Подарок ко дню рождения', sub: 'Выбери в сентябре', tone: 'pink' },
    { icon: 'clock',     title: 'Приоритет записи', sub: 'Без очереди у 14 точек', tone: 'tiffany' },
    { icon: 'sparkles',  title: 'Ранний доступ к акциям', sub: 'За 24 часа до всех', tone: 'gold' },
    { icon: 'qr',        title: 'Оплата QR без комиссии', sub: 'Офлайн у партнёров клуба', tone: 'tiffany' },
  ],

  // ---- История операций: kind = in (начисление) | buy (покупка) | out (списание) ----
  txSeed: [
    { d: 0,  kind: 'in',   title: 'Кэшбек · Пекарня «Слойка»',   sum: 38,   note: 'Слойка с вишней ×2' },
    { d: 0,  kind: 'buy',  title: 'Кофейня «Daily»',             sum: -440, note: 'Капучино ×2 · оплата QR' },
    { d: 1,  kind: 'in',   title: 'Бонус «Приведи друга»',       sum: 200,  note: 'Марат вышел в клуб' },
    ...
    { d: 2,  kind: 'in',   title: 'Кэшбек ×2 пятница',           sum: 64,   note: 'Кофейня «Daily»' },
